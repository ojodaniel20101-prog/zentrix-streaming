...
import {
  Search, Bell, Bookmark, UserCircle, X, ChevronDown,
  Film, Tv, Sword, Home, TrendingUp, Sparkles, Trophy, Trophy
} from "lucide-react";
    ...
    <>
      <motion.nav
        ...
        style={{
          background: scrolled
            ? "rgba(5, 8, 22, 0.95)"
            : "linear-gradient(180deg, rgba(5,8,22,0.85) 0%, rgba(5,8,22,0.4) 70%, transparent 100%)",
