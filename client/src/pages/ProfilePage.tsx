...
import {
  ...
  RefreshCw, Heart, Share2, Grid, List, Filter, Sun, Moon, Monitor,
} from "lucide-react";
        ...
        <AnimatePresence mode="wait">
          ...
          {activeTab === "settings" && (
            <motion.div key="settings" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-4 max-w-2xl">
              ...
              <div className="rounded-2xl p-6" style={{ background: "rgba(11,18,32,0.8)", border: "1px solid rgba(255,255,255,0.06)" }}>
                <h3 className="text-sm font-bold uppercase tracking-wider mb-4" style={{ color: "#8899AA" }}>Appearance</h3>
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 rounded-xl" style={{ background: "rgba(255,255,255,0.02)" }}>
                    <div>
                      <p className="text-sm font-semibold" style={{ color: "#F0F4FF" }}>Theme</p>
                      <p className="text-xs" style={{ color: "#8899AA" }}>Choose your preferred appearance</p>
                    </div>
                    <div className="flex items-center gap-1 p-1 rounded-xl" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.08)" }}>
                      {[
                        ...
                        <button
                          key={value}
                          onClick={() => setPreference(value as any)}
                          className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-semibold transition-all"
                          style={{
                            background: preference === value ? "rgba(0, 212, 255, 0.15)" : "transparent",
                            color: preference === value ? "#00D4FF" : "#8899AA",
                            border: preference === value ? "1px solid rgba(0, 212, 255, 0.3)" : "1px solid transparent",
                          }}
                        >
