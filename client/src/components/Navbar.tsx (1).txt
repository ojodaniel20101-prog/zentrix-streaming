...
import {
  Search, Bell, Bookmark, Menu, X, ChevronDown, Sun, Moon,
...
const navLinks = [
  ...
  { href: "/wrestling", label: "WWE", icon: Trophy },
];
  ...
  return (
    <>
      <motion.nav
        ...
        style={{
          background: scrolled
            ? theme === "dark" ? "rgba(5, 8, 22, 0.92)" : "rgba(240, 244, 255, 0.92)"
            : theme === "dark" ? "linear-gradient(180deg, rgba(5,8,22,0.8) 0%, transparent 100%)" : "linear-gradient(180deg, rgba(240,244,255,0.8) 0%, transparent 100%)",
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Mobile Menu Toggle - Desktop only now */}
              <motion.button
        ...
        <AnimatePresence>
          {mobileOpen && (
            <motion.div
              ...
              style={{
                background: theme === "dark" ? "rgba(5, 8, 22, 0.98)" : "rgba(240, 244, 255, 0.98)",
